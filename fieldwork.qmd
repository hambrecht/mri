...
```
```{r, include=FALSE}
terra::inMemory(LAI2021)   # FALSE means values are not in RAM (pointer object)
terra::sources(LAI2021)    # shows file(s) on disk the raster points to
terra::ncell(LAI2021)      # total number of pixels
4 * terra::ncell(LAI2021)  # approximate bytes of rendered image
...
# Enviroment
  ...
  addLayersControl(
    overlayGroups = c("Base layer: OpenTopo", "Base layer: Mapzen Global Terrain", "Base layer: Relief map of DTM", "Base layer: Aerial Imagery", "Base layer: Private Land", "Area:Survey Area", "Area:Provincal Park", "Area:Township", "Area:Lake", "Aerodrome", "Infrastructure: Buildings", "Infrastructure: Recreation points", "Infrastructure: Towers", "Infrastructure: Roads", "Environment: SBFI 2020 Canopy Cover", "Environment: LAI Winter 2020-2021", "Environment: LAI Winter 2021-2022", "Environment: LAI Winter 2022-2023", "Environment: LAI Winter 2023-2024", "Environment: LAI Winter 2024-2025","Environment: Snow Cover", "Environment: Moose wintering area"),
    options = layersControlOptions(collapsed = FALSE)
  ) %>%
  hideGroup(c("Base layer: OpenTopo", "Base layer: Mapzen Global Terrain", "Base layer: Relief map of DTM", "Base layer: Aerial Imagery", "Base layer: Private Land", "Area:Provincal Park", "Area:Township", "Area:Lake", "Aerodrome", "Infrastructure: Buildings", "Infrastructure: Recreation points", "Infrastructure: Towers", "Infrastructure: Roads", "Environment: SBFI 2020 Canopy Cover","Environment: Moose wintering area", "Environment: Snow Cover", "Environment: LAI Winter 2020-2021", "Environment: LAI Winter 2021-2022", "Environment: LAI Winter 2022-2023", "Environment: LAI Winter 2023-2024", "Environment: LAI Winter 2024-2025"))
```
