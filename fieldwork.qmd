...
# Enviroment
  ...
  addLayersControl(
    overlayGroups = c("Base layer: OpenTopo", "Base layer: Mapzen Global Terrain", "Base layer: Relief map of DTM", "Base layer: Aerial Imagery", "Base layer: Private Land", "Area:Survey Area", "Area:Provincal Park", "Area:Township", "Area:Lake", "Aerodrome", "Infrastructure: Buildings", "Infrastructure: Recreation points", "Infrastructure: Towers", "Infrastructure: Roads", "Environment: SBFI 2020 Canopy Cover", "Environment: LAI Winter 2020-2021", "Environment: LAI Winter 2021-2022", "Environment: LAI Winter 2022-2023", "Environmenrent: LAI Winter 2023-2024", "Environment: LAI Winter 2024-2025", "Environment: Tree Cover Gain 2001-2024", "Environment: Tree Cover Loss 2001-2024", "Environment: Snow Cover", "Environment: Moose wintering area"),
    options = layersControlOptions(collapsed = FALSE)
  ) %>%
  hideGroup(c("Base layer: OpenTopo", "Base layer: Mapzen Global Terrain", "Base layer: Relief map of DTM", "Base layer: Aerial Imagery", "Base layer: Private Land", "Area:Provincal Park", "Area:Township", "Area:Lake", "Aerodrome", "Infrastructure: Buildings", "Infrastructure: Recreation points", "Infrastructure: Towers", "Infrastructure: Roads", "Environment: SBFI 2020 Canopy Cover","Environment: Moose wintering area", "Environment: Snow Cover", "Environment: LAI Winter 2020-2021", "Environment: LAI Winter 2021-2022", "Environment: LAI Winter 2022-2023", "Environment: LAI Winter 2023-2024", "Environment: LAI Winter 2024-2025", "Environment: Tree Cover Gain", "Environment: Tree Cover Loss 2001-2024", "Environment: Snow Cover 2001-2024"))
```
